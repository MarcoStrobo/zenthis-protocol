...
async function main() {
  ...
  console.log(
    "   Flat airdrop:",
    ethers.formatEther(await presale.getFlatBonus(user.address)),
    "ZTS",
  );
  console.log(
    "   Tier bonus:",
    ethers.formatEther(await presale.getTierBonus(user.address)),
    "ZTS",
  );
  console.log(
    "   Claimable:",
    ethers.formatEther(await presale.getClaimableAmount(user.address)),
    "ZTS",
  );
